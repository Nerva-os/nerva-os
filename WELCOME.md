...
```
You are about to install Nerva OS — my AI business assistant kit.

Please do the following in order:

1. Clone the Nerva OS repository to ~/nerva-os
   (git clone https://github.com/nerva-os/nerva-os.git ~/nerva-os)

2. Copy the workspace template from ~/nerva-os/workspace
   to ~/my-assistant (this is where I will work every day)

3. Copy every skill from ~/nerva-os/skills/ to ~/.claude/skills/
   (there are 37 skills — confirm the count when done)

4. Open ~/my-assistant/CLAUDE.md and follow the
   first-run-setup skill to onboard me

5. Once setup is complete, ask me the 7 onboarding
   questions to build my memory file

When everything is ready, tell me to close Claude Desktop,
reopen it, and open the ~/my-assistant folder.
```
