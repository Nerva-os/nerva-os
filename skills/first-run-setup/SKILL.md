...
- If empty or missing → "It looks like your skills did not copy correctly. Let me fix that."
 1. Check if `~/nerva-os/skills/` exists
 2. If yes → copy all skill folders (not SKILLS-LIST.md) to `~/.claude/skills/`
 3. If no → re-download: `git clone https://github.com/nerva-os/nerva-os.git ~/nerva-os` then copy.
...
**Today's win:** [what success looks like]
...
- Windows: Git for Windows needs to be installed. See the Nerva OS WELCOME page or `docs/09-troubleshooting.md` for the step-by-step.
